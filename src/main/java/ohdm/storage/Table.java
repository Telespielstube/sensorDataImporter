...
public class Table implements TableInterface {
    ...
    public void createFineDustTable() throws SQLException {
        PreparedStatement statement = db.connection.prepareStatement("CREATE SEQUENCE IF NOT EXISTS ohdm.fine_dust_data_id_seq;" +
    ...
    public void createTemperatureTable() throws SQLException {
        PreparedStatement statement = db.connection
                .prepareStatement("CREATE SEQUENCE IF NOT EXISTS ohdm.temperatur_data_id_seq;" +
                        "CREATE TABLE IF NOT EXISTS ohdm.temperature_data\n" + 
                        "(\n" + 
                        "    id bigint NOT NULL DEFAULT nextval('ohdm.temperatur_data_id_seq'::regclass),\n" + 
                        "    temperature real,\n" + 
                        "    humidity real,\n" + 
